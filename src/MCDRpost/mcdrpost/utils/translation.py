...
class TranslationKeys:
    ...
    deprecation_replacement_info = TranslationKeyItem(
        "mcdrpost.deprecation.replacement_info"
    )
    ...
    post_fail_reached_max_storage = TranslationKeyItem(
        "mcdrpost.command.post.fail.reached_max_storage"
    )
    post_fail_send_to_self = TranslationKeyItem(
        "mcdrpost.command.post.fail.send_to_self"
    )
    post_fail_invalid_item = TranslationKeyItem(
        "mcdrpost.command.post.fail.invalid_item"
    )
    post_fail_receiver_unregistered = TranslationKeyItem(
        "mcdrpost.command.post.fail.receiver_unregistered"
    )
    ...
    receive_fail_hands_not_cleared = TranslationKeyItem(
        "mcdrpost.command.receive.fail.hands_not_cleared"
    )
    receive_fail_undefined_id = TranslationKeyItem(
        "mcdrpost.command.receive.fail.undefined_id"
    )
    ...
    cancel_fail_hands_not_cleared = TranslationKeyItem(
        "mcdrpost.command.cancel.fail.hands_not_cleared"
    )
    cancel_fail_undefined_id = TranslationKeyItem(
        "mcdrpost.command.cancel.fail.undefined_id"
    )
    ...
    player_fail_already_registered = TranslationKeyItem(
        "mcdrpost.command.player.fail.already_registered"
    )
    player_fail_unable_del = TranslationKeyItem(
        "mcdrpost.command.player.fail.unable_del"
    )

    # command - error
    error_incomplete_general = TranslationKeyItem(
        "mcdrpost.command.error.incomplete.general"
    )
    error_incomplete_receiver = TranslationKeyItem(
        "mcdrpost.command.error.incomplete.receiver"
    )
    error_incomplete_order_id = TranslationKeyItem(
        "mcdrpost.command.error.incomplete.order_id"
    )
    ...
    help_info_receive_list = TranslationKeyItem(
        "mcdrpost.command.help.info.receive_list"
    )
    ...
    help_info_list_players = TranslationKeyItem(
        "mcdrpost.command.help.info.list_players"
    )
    ...
    help_info_player_remove = TranslationKeyItem(
        "mcdrpost.command.help.info.player.remove"
    )
    ...
    help_usage_player_remove = TranslationKeyItem(
        "mcdrpost.command.help.usage.player.remove"
    )
